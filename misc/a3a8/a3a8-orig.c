...
void A3A8(/* in */ iu8 key[16], /* in */ iu8 rand[16],
	/* out */ iu8 simoutput[12]);

/* The compression tables. */
static const iu8 table_0[512] = {
...
{
	iu8 rand[16], key [16], simoutput[12];
	int i;
	...
	/* Arguments where in wrong order */
